...
export class AppConfig extends Construct {
  constructor(scope: Construct, id: string, props: AppConfigProps = defaultProps) {
    ...
    // const profile = new appconfig.CfnConfigurationProfile(this, 'AppConfig-Profile', {
    //   applicationId: appConfig.ref,
    //   type: 'AWS.Freeform',
    //   name: 'MPA Application configuration',
    //   locationUri: 'config',
    //   description: 'MPA Application configuration (freeform)'
    // });
    ...
    // new appconfig.CfnHostedConfigurationVersion(this, 'v1', {
    //   applicationId: appConfig.ref,
    //   configurationProfileId: profile.ref,
    //   contentType: 'application/json',
